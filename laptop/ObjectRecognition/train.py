...
if __name__ == "__main__":
    ...
    # 获取classes和anchor的位置
    classes_path = 'D:/ObjectRecognition/model_data/voc_classes.txt'
    anchors_path = 'D:/ObjectRecognition/model_data/yolo_anchors.txt'
    # 预训练模型的位置
    weights_path = 'D:/ObjectRecognition/model_data/yolov4_tiny_weights_coco.h5'
    # 获得classes和anchor
